...
import CreateGame from './Games/pages/CreateGame/CreateGame';
import MyGames from './Games/pages/MyGames/MyGames';
import BirdShooterGame from './Games/pages/BirdShooterGame/BirdShooterGame';
